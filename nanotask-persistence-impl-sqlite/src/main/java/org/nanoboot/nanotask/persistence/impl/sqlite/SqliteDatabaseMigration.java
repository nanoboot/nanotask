...
package org.nanoboot.nanotask.persistence.impl.sqlite;
...
public class SqliteDatabaseMigration {
    ...
    public MigrationResult migrate() {
        ...
        String jdbcUrl= "jdbc:sqlite:" + System.getProperty("nanotask.confpath") + "/" + "nanotask.sqlite";
        System.err.println("jdbcUrl=" + jdbcUrl);
        String clazz = this.getClass().getName();
        DBMigration dbMigration = DBMigration
                .configure()
                .dataSource(jdbcUrl)
                .installedBy("nanotask-persistence-impl-sqlite")
                .name("nanotask")
